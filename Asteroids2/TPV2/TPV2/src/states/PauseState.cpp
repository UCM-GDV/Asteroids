...
PauseState::PauseState() : Manager() {
	...
	textTextures_[pressToContinue] = new Texture(sdlutils().renderer(), PRESS_TO_CONTINUE_TEXT, sdlutils().fonts().at("ARIAL24"), build_sdlcolor(0x112233ff), build_sdlcolor(0xffffffff));
}
