...
const Vector2D FIGHTER_2_POS = { WIN_WIDTH - FIGHTER_WIDTH - 50 , WIN_HEIGHT / 2 };
const float FIGHTER_1_ROTATION = 90;
const float FIGHTER_2_ROTATION = -90;
...
const Vector2D LIVES_1_POSITION = Vector2D(10, WIN_HEIGHT / LIVES_HEIGHT);
const Vector2D LIVES_2_POSITION = Vector2D(WIN_WIDTH - 10 - NUMBER_LIVES * LIVES_WIDTH, WIN_HEIGHT / LIVES_HEIGHT);
