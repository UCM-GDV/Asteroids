...
private:
    ...
    void onCollision_Multiplayer(int fighterHealth = 0);
    ...
    string ip;
    string ipWithSpaces;
    // Anade caracter a name
    void addCharacter();
    // Anade espacios para que se vea correctamente la textura
    void addSpaces(string text, string& textWithSpaces);
	// Anade numeros o puntos para ip
    void addNumberOrDot();
